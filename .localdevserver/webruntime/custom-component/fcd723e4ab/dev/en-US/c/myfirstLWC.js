Webruntime.define('lwc/myfirstLWC', ['lwc'], function (lwc) { 'use strict';
    ...
    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".container" + shadowSelector + "{display: flex;flex-direction: column;}\n.not" + shadowSelector + "\rbutton" + shadowSelector + " {color: white;padding: 8px 15px;background: rgb(225, 29, 94);border: 0px solid pink;border-radius: 20px;font-size: smaller;}\n";
    }
