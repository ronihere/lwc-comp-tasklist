Webruntime.define('lwc/myfirstLWC', ['lwc'], function (lwc) { 'use strict';
    ...
    var sf_noob = '/assets/project/0441c6ceef/staticresources/sf_noob';

    class MyfirstLWC extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.url = '';
        this.sf_noob_bg = sf_noob + '/sf_images/Vectorbackground.png';
        this.sf_noob_fg = sf_noob + '/sf_images/Vectorupper.png';
      }
      connectedCallback() {
        this.url = `${this.sf_noob_bg}/Vectorupper.png`;
        console.log(this.url);
      }
    }
    lwc.registerDecorators(MyfirstLWC, {
      fields: ["url", "sf_noob_bg", "sf_noob_fg"]
    });
