Webruntime.define('lwc/myfirstLWC', ['lwc'], function (lwc) { 'use strict';
    ...
    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".container" + shadowSelector + "{display: flex;flex-direction: column;}\n.notfound" + shadowSelector + "{align-self: center;}\nbutton" + shadowSelector + " {height: 30px;width: 120px;color: white;padding: 8px 15px;background: rgb(225, 29, 94);border: 0px solid pink;border-radius: 20px;font-size: smaller;align-self: center;}\n";
    }
