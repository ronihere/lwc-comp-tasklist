Webruntime.define('lwc/myfirstLWC', ['lwc', '@salesforce'], function (lwc, _salesforce) { 'use strict';

    _salesforce = _salesforce && Object.prototype.hasOwnProperty.call(_salesforce, 'default') ? _salesforce['default'] : _salesforce;
