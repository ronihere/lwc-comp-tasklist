Webruntime.define('lwc/myfirstLWC', ['lwc'], function (lwc) { 'use strict';
    ...
    var sf_noob = '/assets/project/de3beff5a5/staticresources/sf_noob';

    class MyfirstLWC extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.sf_noob_bg = sf_noob + '/sf_zip/Vectorbackground.png';
        this.sf_noob_fg = sf_noob + '/sf_zip/Vectorupper.png';
      }
    }
