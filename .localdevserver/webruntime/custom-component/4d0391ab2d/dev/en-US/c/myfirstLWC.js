Webruntime.define('lwc/myfirstLWC', ['lwc'], function (lwc) { 'use strict';
    ...
    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".container" + shadowSelector + "{display: flex;flex-direction: column;}\nbutton" + shadowSelector + " {color: white;padding: 8px 15px;background: rgb(225, 29, 94);border: 0px solid pink;border-radius: 20px;font-size: smaller;}\n";
    }
    ...
    function tmpl($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        key: 2
      }, [api_text("Sorry , The page you requested")]), api_element("button", {
        key: 3
      }, [api_text("Go Back")])])];
    }
